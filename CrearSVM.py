...
# ======================
# 9. eliminación de columnas redundantes (sin eliminar las numéricas originales)
# ======================
derived_drop = [
...
num_cols = [
    'funding_rounds', 'has_VC', 'has_angel', 'lifetime_years',
...
# ======================
# 14. pipeline completo con SVM probabilístico
# ======================
pipe = Pipeline([
    ('prep', preprocessor),
...
print("pipeline entrenado guardado en models/svm_pipeline.pkl")
